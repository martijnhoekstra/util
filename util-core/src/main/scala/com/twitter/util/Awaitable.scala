...
// See https://stackoverflow.com/questions/26643045/java-interoperability-woes-with-scala-generics-and-boxing
private[util] trait CloseOnceAwaitably0[U <: Unit] extends Awaitable[U] { self: (CloseOnce with com.twitter.util.Closable) =>
 ...
 * }}}
 */
trait CloseOnceAwaitably extends CloseOnceAwaitably0[Unit] { self: (CloseOnce with com.twitter.util.Closable) => }
